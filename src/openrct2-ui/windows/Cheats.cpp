...
#define FRAME_MONEY_START 69
    { WWT_GROUPBOX,    1,      5,    242,    FRAME_MONEY_START +  0,   FRAME_MONEY_START +  68,    STR_ADD_SET_MONEY,         STR_NONE },    // add / set money group frame
      SPINNER_WIDGETS (1,     11,    236,    FRAME_MONEY_START + 23,   FRAME_MONEY_START +  34,    STR_NONE,                  STR_NONE),     // money value
...
#define FRAME_DATE_START 184
    { WWT_GROUPBOX,    1,      5,    242,    FRAME_DATE_START +   0,   FRAME_DATE_START + 100,    STR_DATE_SET,              STR_NONE },    // Date group
      SPINNER_WIDGETS (1,    120,    236,    FRAME_DATE_START +  13,   FRAME_DATE_START +  24,    STR_NONE,                  STR_NONE),     // Year box
      SPINNER_WIDGETS (1,    120,    236,    FRAME_DATE_START +  34,   FRAME_DATE_START +  45,    STR_NONE,                  STR_NONE),     // Month box
      SPINNER_WIDGETS (1,    120,    236,    FRAME_DATE_START +  55,   FRAME_DATE_START +  66,    STR_NONE,                  STR_NONE),     // Day box
...
#define FRAME_GENERAL_START 48
    ...
    { WWT_CHECKBOX,    1,     11,    120,   FRAME_GENERAL_START + 105,   FRAME_GENERAL_START + 121,    STR_FORCE_PARK_RATING,              STR_NONE },                              // Force park rating
      SPINNER_WIDGETS (1,    126,    236,   FRAME_GENERAL_START + 107,   FRAME_GENERAL_START + 118,    STR_NONE,                           STR_NONE),                               // park rating
